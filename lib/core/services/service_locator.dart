...
// import 'package:movies_app/_tv_shows/domain/usecases/get_season_details_usecase.dart';
import 'package:movies_app/features/domain/movies/repository/movies_repository.dart';
import 'package:movies_app/features/domain/movies/usecases/get_all_popular_movies_usecase.dart';
import 'package:movies_app/features/domain/movies/usecases/get_all_top_rated_movies_usecase.dart';
import 'package:movies_app/features/domain/movies/usecases/get_movie_details_usecase.dart';
import 'package:movies_app/features/domain/movies/usecases/get_movies_usecase.dart';
import 'package:movies_app/features/domain/search/repository/search_repository.dart';
import 'package:movies_app/features/domain/search/usecases/search_usecase.dart';
import 'package:movies_app/features/domain/tv_shows/repository/tv_shows_repository.dart';
import 'package:movies_app/features/domain/tv_shows/usecases/get_all_popular_tv_shows_usecase.dart';
import 'package:movies_app/features/domain/tv_shows/usecases/get_all_top_rated_tv_shows_usecase.dart';
import 'package:movies_app/features/domain/tv_shows/usecases/get_season_details_usecase.dart';
import 'package:movies_app/features/domain/tv_shows/usecases/get_tv_show_details_usecase.dart';
import 'package:movies_app/features/domain/tv_shows/usecases/get_tv_shows_usecase.dart';
import 'package:movies_app/features/domain/watchlist/repository/watchlist_repository.dart';
import 'package:movies_app/features/domain/watchlist/usecases/add_watchlist_item_usecase.dart';
import 'package:movies_app/features/domain/watchlist/usecases/check_if_item_added_usecase.dart';
import 'package:movies_app/features/domain/watchlist/usecases/get_watchlist_items_usecase.dart';
import 'package:movies_app/features/domain/watchlist/usecases/remove_watchlist_item_usecase.dart';
import 'package:movies_app/features/infrastructure/movies/datasource/movies_remote_data_source.dart';
import 'package:movies_app/features/infrastructure/movies/repository/movies_repository_impl.dart';
import 'package:movies_app/features/infrastructure/search/datasource/search_remote_data_source.dart';
import 'package:movies_app/features/infrastructure/search/repository/search_repository_impl.dart';
import 'package:movies_app/features/infrastructure/tv_shows/datasource/tv_shows_remote_data_source.dart';
import 'package:movies_app/features/infrastructure/tv_shows/repository/tv_shows_repository_impl.dart';
import 'package:movies_app/features/infrastructure/watchlist/datasource/watchlist_local_data_source.dart';
import 'package:movies_app/features/infrastructure/watchlist/repository/watchlist_repository_impl.dart';
import 'package:movies_app/features/presentation/movies/controllers/movie_details_bloc/movie_details_bloc.dart';
import 'package:movies_app/features/presentation/movies/controllers/movies_bloc/movies_bloc.dart';
import 'package:movies_app/features/presentation/movies/controllers/popular_movies_bloc/popular_movies_bloc.dart';
import 'package:movies_app/features/presentation/movies/controllers/top_rated_movies_bloc/top_rated_movies_bloc.dart';
import 'package:movies_app/features/presentation/search/controllers/search_bloc/search_bloc.dart';
import 'package:movies_app/features/presentation/tv_shows/controllers/popular_tv_shows_bloc/popular_tv_shows_bloc.dart';
import 'package:movies_app/features/presentation/tv_shows/controllers/top_rated_tv_shows_bloc/top_rated_tv_shows_bloc.dart';
import 'package:movies_app/features/presentation/tv_shows/controllers/tv_show_details_bloc/tv_show_details_bloc.dart';
import 'package:movies_app/features/presentation/tv_shows/controllers/tv_shows_bloc/tv_shows_bloc.dart';
